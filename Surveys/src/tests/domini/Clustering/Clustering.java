...
public class Clustering {
     ...
     * @return
     */
    public RespCualitativaNoOrdenadaMultiple
     ...
     * @return
     */
    public RespCualitativaNoOrdenadaUnica
     ...
     * @return
     */
    public RespCualitativaOrdenada
     ...
     * @return
     */
    public RespNumerica Respnum_avg (int cli, int rn,  final ArrayList<Integer> assig, final ArrayList<RespuestasEncuesta> RE){
        double sum,count;
        sum = count = 0;
     ...
     */
    public void show_clusters(ArrayList<RespuestasEncuesta> RE, ArrayList<Integer> assig, int n){
